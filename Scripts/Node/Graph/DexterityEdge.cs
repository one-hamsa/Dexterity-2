...
namespace OneHamsa.Dexterity
{
    ...
    /// or another <see cref="GraphAggregator"/> on the same GameObject.
    ///
    ...
    {
        /// <summary>Target component on the host GameObject. Must be a GraphNode or GraphAggregator.</summary>
        public Component target;

        /// <summary>
        /// When target is a <see cref="GraphNode"/>, the state-input port name to feed.
        /// When target is a <see cref="GraphAggregator"/>, ignored (aggregators consume their
